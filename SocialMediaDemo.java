...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        YouTubeSocialMediaEntryAdapter video1 = new YouTubeSocialMediaEntryAdapter(new YouTubeVideo("MormonMessages", "Bullying",
                "President Uchtdorf counsels us to stop bullying."));
        
        YouTubeSocialMediaEntryAdapter video2 = new YouTubeSocialMediaEntryAdapter(new YouTubeVideo("MormonMessages", "Patterns of Light",
                "Elder Bednar teaches about the Light of Christ."));
        
        YouTubeSocialMediaEntryAdapter video3 = new YouTubeSocialMediaEntryAdapter(new YouTubeVideo("Randy Pausch", "The Last Lecture",
